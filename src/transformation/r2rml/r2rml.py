...
from transformation.r2rml.commands.pytransform import pytransform_, PyTransformNewColumnCmd


Command = Union[PyTransformNewColumnCmd, SetInternalLinkCmd, SetSemanticTypeCmd]
...
class R2RML(object):
    ...
    def apply_cmds(self, tbl: DataTable) -> SemanticModel:
        ...
        for cmd in self.commands:
            if isinstance(cmd, PyTransformNewColumnCmd):
                ...
                print(cmd.input_attr_path, id_map)
    ...
    def pytransform(self, tbl: DataTable, cmd: PyTransformNewColumnCmd):
    ...
    def to_kr2rml(self, ont: Ontology, tbl: DataTable, fpath: Union[str, Path]):
        ...
        for cmd in commands:
            if isinstance(cmd, PyTransformNewColumnCmd):
                ...
                if cmd.type != "karma:classLink":
                        ...
                        "inputParameters": [
                            ...
                            {"name": "selectionName", "value": "DEFAULT_TEST", "type": "other"},
                            {
                                ...
                                "value": [{
                                    ...
                                    "isPrimary": True,
                                    "DomainLabel": ont.simplify_uri(cmd.node_id),
                                    "DomainId": ont.full_uri(cmd.node_id),
                    ...
                    worksheet_history.append({
                        ...
                        "inputParameters": [
                            ...
                            {"name": "metaPropertyId", "value": ont.full_uri(cmd.node_id), "type": "other"},
                            {
                                "name": "SemanticTypesArray",
                                "type": "other",
                                "value": [{
                ...
                #                     "edgeTargetId": ont.full_uri(cmd.target_id),
                #                     "edgeTargetUri": ont.full_uri(cmd.target_uri or cmd.target_id[:-1]),
                #                     "edgeSourceId": ont.full_uri(cmd.source_id),
