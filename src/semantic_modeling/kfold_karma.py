...
from debugging.assembling.visualize_training_data import colorize_prediction
...
from previous_work.mohsen_jws2015.app import MohsenSemanticModeling
from previous_work.mohsen_jws2015.app_extra import SemanticModelAlignment
...
def run_evaluation_workflow(dataset: str, scenario: Scenario, train_sms, test_sms):
    ...
    need_render_graphs = [(colorize_prediction(pred_sm.graph,
                          ...
                          for sm, pred_sm in zip(semantic_models, pred_sms)]
...
if __name__ == '__main__':
    ...
    shutil.move(get_cache_dir(args.dataset, train_sms) / "mohsen_jws2015", exp_dir / f"mohsen_jws2015_{get_short_train_name(train_sms)}")
