...
class Settings(object):
    ...
    def parse_shell_args(print_settings: bool = True):
        ...
        parser.add_argument('--semantic_labeling_method', type=str, default='ReImplMinhISWC',
                            help='can be OracleSL, ReImplMinhISWC and MohsenISWC, default ReImplMinhISWC')
        parser.add_argument('--semantic_labeling_top_n_stypes', type=int, default=4, help='Default is top 4')

        parser.add_argument('--auto_labeling_method', type=str, default='AUTO_LBL_MAX_F1',
                            help='can be AUTO_LBL_MAX_F1 and AUTO_LBL_PRESERVED_STRUCTURE (default AUTO_LBL_MAX_F1)')
        ...
        parser.add_argument('--searching_early_stopping_method', type=str, default='NoEarlyStopping',
                            help='can be NoEarlyStopping or MinProb (default NoEarlyStopping)')
        parser.add_argument('--searching_early_stopping_minimum_expected_accuracy', type=int, default=0,
                            help='default 0')
        parser.add_argument('--searching_early_stopping_min_prob_args', type=str, default="[0.01]",
